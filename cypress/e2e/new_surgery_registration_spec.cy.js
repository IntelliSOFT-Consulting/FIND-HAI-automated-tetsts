...
const emailAddress = familyName.toLowerCase() + firstName.toLowerCase()
 describe("Acccess the homepage menu of the platform",()=>{
  ...
  it.only("test2 - tests registration of a new surgery currently",()=>{
        ...
        cy.get('#Y4bglcLiAGx').click().focused().get('.ant-picker-year-btn').dblclick().get('tbody > :nth-child(1) > :nth-child(1)').click().get('[title="1997"]').click().get('[title="1997-03"]').click().get('[title="1997-03-03"]').click()
